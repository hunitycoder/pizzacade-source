...
namespace poker.view
{
    ...
    public class CardView : MonoBehaviour
    {
        ...
        private void UpdateImage()
        {
            ...
            string cardPath = suit.ToString() + "_" + (val + 1).ToString();
            //Debug.Log(cardPath + "_____" + ToString());
            _image.sprite = Resources.Load<Sprite>("Images/Cards/" + cardPath);
        }
        public void HideCard()
        {
            _image.sprite = Resources.Load<Sprite>("Images/Cards/CardBack");
        }
